...
public class Puits implements IArea3D {
	...
	public Puits() {
		if (WIDTH!=DEPTH) throw new Error("WIDTH != DEPTH");
		for (int i=0;i<WIDTH;i++) {
		 ...
		 BufferedImage image1 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512RT.png"));//The path is inside the jar file
		 this.imageRT = TextureLoader.toByteBuffer(image1);
		 BufferedImage image2 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512LT.png"));//The path is inside the jar file
		 this.imageLT = TextureLoader.toByteBuffer(image2);
		 BufferedImage image3 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512UP.png"));//The path is inside the jar file
		 this.imageUP = TextureLoader.toByteBuffer(image3);
		 BufferedImage image4 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512DN.png"));//The path is inside the jar file
		 this.imageDN = TextureLoader.toByteBuffer(image4);
		 BufferedImage image5 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512BK.png"));//The path is inside the jar file
		 this.imageBK = TextureLoader.toByteBuffer(image5);
		 BufferedImage image6 = TextureLoader.loadImage(TempestMain.class.getResource("nightsky512FT.png"));//The path is inside the jar file
